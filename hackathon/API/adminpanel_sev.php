...
<body>
    ...
    <table class="data-table">
        <caption class="title">Incidents Sorted By Severity</caption>
        <thead>
            <tr>
              <th>NO</th>
              <th>Latitude</th>
              <th>Longitude</th>
              <th><a href="adminpanel.php">Severity</a></th>
        ...
        $query = mysqli_query($conn,"SELECT * FROM hackathon ORDER BY severity");
        $no     = 1;
        $total  = 0;
